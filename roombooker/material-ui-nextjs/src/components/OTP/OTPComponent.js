...
import { verify_otp } from "@/repository/用户Repo";
...
export default function OTPInput() {
  ...
  const handleSubmitOTP = async () => {
    const temp_data = {
      ...
      otp: otp,
      otp_purpose: sessionStorage.getItem("otp_purpose"),
    };
    console.log(temp_data);

    try {
      const data = await verify_otp(temp_data); // data is already JSON
  ...
  return (
    ...
    >
      ...
      {/* <span color={msg_color}>{message}</span> */}
